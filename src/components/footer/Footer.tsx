                ...
                <div className="footer__copy">
                    <div>
                        ...
                        <p>
                            ...
                            Внешний вид и состав блюд могут отличаться от
                            представленных на сайте. Подробности у операторов.
                            акции и скидки не суммируются и не распространяются
                            на наборы, десерты, напитки
                        </p>
                    </div>
                    <div>
